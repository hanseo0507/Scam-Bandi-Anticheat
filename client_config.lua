...
Config.AntiInjection = false

Config.EulenInjection = true

Config.AntiInjectionCommand = true

Config.AntiGodmode = false

Config.AntiInfinityAmmo = true

Config.PlayerProtection = true

Config.PedBlacklist = true

Config.AntiProps = true
